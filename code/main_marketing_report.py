...
import sys
from sales_pipeline import (get_raw_sales_data,clean_sales_data,summarize_by_item,find_top_entry,print_item_table,)
# --- The report ------------------------------------------------------------------
#
...
#ODO: import what this report needs from the package.


# TDO: handle the optional dataset seed. This is the same three lines the Finance
#       report has — read them there, then write them here yourself.
seed = None
if len(sys.argv) > 1 and sys.argv[1].strip() != "":
    seed = int(sys.argv[1])

# TDO: print the header, exactly:   === MARKETING: Revenue by Item ===
#       then a blank line.
